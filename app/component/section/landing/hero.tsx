...
<div className="relative isolate overflow-hidden bg-gray-900">
  ...
  <div className="mt-[-50px] flex h-[36rem] items-center justify-center">
    <div className="max-w-full flex-shrink-0 px-4 text-center lg:mx-0 lg:max-w-3xl lg:pt-8">
      ...
      Reconnect,
        <span className="text-sky-500">Mentor, Inspire </span> 
        
      </h1>
      <p className="mt-6 text-lg leading-8 text-gray-300">Bridging Alumni and Students for a Brighter Future</p>
